...
const FAQ_ITEMS = [
  ...
  { q: "The result isn't what I expected — do I get a refund?", a: "Credits are consumed on every successful generation, as each run carries a real compute cost regardless of the outcome. Small adjustments to your photo (sharper focus, better lighting, a plain background) or a more specific description often improve the result significantly. If the output appears genuinely broken rather than simply not matching your preferred style, please contact support and we will make it right." },
  { q: "How does Refer & Earn work?", a: "Share your personal referral link from the Refer & Earn page inside the app. When a jeweller signs up through it and makes their first purchase, you both receive 10 free credits. This is capped at 10 successful referrals per jeweller, for up to 100 free credits in total." },
